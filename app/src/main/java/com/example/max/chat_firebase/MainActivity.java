    ...
    private void deleteFromFirebase() {
        ...
        mStorage.child("users").child(currentUserAuth.getUid()).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (databaseError == null) {
                                mDatabase.child("users").child(currentUserAuth.getUid()).removeValue(new DatabaseReference.CompletionListener() {
                                    ...
                                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                        ...
                                        else {MApplication.makeToast(getResources().getString(R.string.delete_account_not_successfully_firebase_database), MainActivity.this);}
                                    }
                                });
                            }
                            else {MApplication.makeToast(getResources().getString(R.string.delete_account_not_successfully_firebase_database), MainActivity.this);}
                ...
                else {MApplication.makeToast(getResources().getString(R.string.delete_account_not_successfully_firebase_storage), MainActivity.this);}
            }
        });
    }
